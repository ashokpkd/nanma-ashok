...
const HomeBanner = () => {
  return (
      <div className='w-[80vw] bg-black text-white flex flex-col-reverse sm:flex-row mt-5 '>
          <div className='sm:w-[50%] flex flex-col ml-10 mb-10 gap-3 sm:ml-16 sm:mt-12 md:ml-16 md:mt-12 lg:ml-16 lg:mt-12 xl:mt-20 xl:ml-32 '>
              <div className='flex items-center gap-1 text-xs'><FaApple size={40}/><p>iPhone 14 Series</p> </div>
              <div className='flex text-2xl md:text-3xl lg:text-4xl xl:text-5xl  font-bold'><p>Up to 10%<br/>off Voucher</p></div>
